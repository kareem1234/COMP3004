...
**
<<<<<<< HEAD
** Created: Mon Nov 4 11:20:33 2013
=======
** Created: Mon Nov 4 12:11:19 2013
...
static const char qt_meta_stringdata_Courses[] = {
    "Courses\0"
};
...
const QMetaObjectExtraData Courses::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Courses::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Courses,
      qt_meta_data_Courses, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Courses::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Courses))
