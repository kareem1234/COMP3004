...
**
** Created: Sat Nov 30 16:47:05 2013
...
public:
    ...
    void setupUi(QDialog *TaskCreated)
    {
        ...
        taskDescription->setGeometry(QRect(120, 70, 241, 16));
        dueDate = new QLabel(TaskCreated);
        dueDate->setObjectName(QString::fromUtf8("dueDate"));
        dueDate->setGeometry(QRect(90, 20, 60, 21));
        label_4 = new QLabel(TaskCreated);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setGeometry(QRect(30, 140, 171, 16));
        passTag = new QLabel(TaskCreated);
        passTag->setObjectName(QString::fromUtf8("passTag"));
        passTag->setGeometry(QRect(210, 140, 111, 16));
    ...
    void retranslateUi(QDialog *TaskCreated)
    {
        ...
        label_4->setText(QApplication::translate("TaskCreated", "Task recieved successfully:", 0, QApplication::UnicodeUTF8));
