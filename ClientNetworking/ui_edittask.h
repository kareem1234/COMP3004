...
**
** Created: Mon Nov 4 00:02:36 2013
...
public:
    ...
    void setupUi(QDialog *EditTask)
    {
        ...
        typeBefore->setGeometry(QRect(130, 60, 60, 16));
        typeAfter = new QLabel(EditTask);
        typeAfter->setObjectName(QString::fromUtf8("typeAfter"));
        typeAfter->setGeometry(QRect(290, 60, 60, 16));
